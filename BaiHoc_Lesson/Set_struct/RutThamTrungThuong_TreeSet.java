...
import java.util.TreeSet;//La them phan tu vao tap hop nhung co quan tam den thu tu cua gia tri
...
public class RutThamTrungThuong_TreeSet {
	...
	public RutThamTrungThuong_TreeSet() {
		this.thungPhieu = new TreeSet<String>();//Cap phat bo nho bang giao dien hash set
	}
	
	public RutThamTrungThuong_TreeSet(Set<String> thungPhieu){	//Ham xay dung co doi so
		this.thungPhieu = thungPhieu;
	}
	public RutThamTrungThuong_TreeSet(RutThamTrungThuong_HashSet X) {	//Ham xay dung sao chep co doi so
		this.thungPhieu = new TreeSet<String>(X.thungPhieu);
	}
	//Them 1 phieu
